...
<div class="row">
  ...
  <div class="main">
    <h2>Testimony of Lisa</h2>
    <h5>Safety, Social, and Free!!!! July 6, 2019</h5>
    <div style="background-size:contain;background-repeat:no-repeat;
	            background-image:url('person1.jpg');height:200px;"></div>
    <p>Lisa</p>
    <p>Carride let you book a ride to your destination for free.My experience with Carride has been wonderful. Years of wonderful and joyful experiences. Every time the ride was free. The pupil hosting the ride loved me. I was there always parting wisdom to them if they needed.
